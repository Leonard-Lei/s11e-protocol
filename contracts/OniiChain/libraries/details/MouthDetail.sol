...
contract MouthDetail {
    /// @dev Mouth N°1 => Neutral
    function mouthDetailItem1() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°2 => Smile
    function mouthDetailItem2() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°3 => Sulk
    function mouthDetailItem3() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°4 => Poker
    function mouthDetailItem4() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°5 => Angry
    function mouthDetailItem5() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    function mouthDetailItem6() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°7 => Evil
    function mouthDetailItem7() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    function mouthDetailItem8() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°9 => Drool
    function mouthDetailItem9() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°10 => O
    function mouthDetailItem10() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°11 => Dubu
    function mouthDetailItem11() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    function mouthDetailItem12() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mouth N°13 => Uwu
    function mouthDetailItem13() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    function mouthDetailItem14() public pure returns (string memory) {
        return
            mouthBase(
                string(
                    abi.encodePacked(
    ...
    function getMouthItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Neutral";
        } else if (id == 2) {
    ...
    /// @dev The mouthBase SVG for the mouth
    function mouthBase(string memory children) private pure returns (string memory) {
