...
contract HairDetail {
    ...
    function hairDetailItem1() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.BROWN));
    }

    /// @dev Hair N°2 => Classic Black
    function hairDetailItem2() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.BLACK));
    }

    /// @dev Hair N°3 => Classic Gray
    function hairDetailItem3() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.GRAY));
    }

    /// @dev Hair N°4 => Classic White
    function hairDetailItem4() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.WHITE));
    }

    /// @dev Hair N°5 => Classic Blue
    function hairDetailItem5() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.BLUE));
    }

    /// @dev Hair N°6 => Classic Yellow
    function hairDetailItem6() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.YELLOW));
    }

    /// @dev Hair N°7 => Classic Pink
    function hairDetailItem7() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.PINK));
    }

    /// @dev Hair N°8 => Classic Red
    function hairDetailItem8() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.RED));
    }

    /// @dev Hair N°9 => Classic Purple
    function hairDetailItem9() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.PURPLE));
    }

    /// @dev Hair N°10 => Classic Green
    function hairDetailItem10() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.GREEN));
    }

    /// @dev Hair N°11 => Classic Saiki
    function hairDetailItem11() public pure returns (string memory) {
        return hairBase(classicHairs(Colors.SAIKI));
    }

    /// @dev Hair N°12 => Classic 2 Brown
    function hairDetailItem12() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.BROWN));
    }

    /// @dev Hair N°13 => Classic 2 Black
    function hairDetailItem13() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.BLACK));
    }

    /// @dev Hair N°14 => Classic 2 Gray
    function hairDetailItem14() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.GRAY));
    }

    /// @dev Hair N°15 => Classic 2 White
    function hairDetailItem15() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.WHITE));
    }

    /// @dev Hair N°16 => Classic 2 Blue
    function hairDetailItem16() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.BLUE));
    }

    /// @dev Hair N°17 => Classic 2 Yellow
    function hairDetailItem17() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.YELLOW));
    }

    /// @dev Hair N°18 => Classic 2 Pink
    function hairDetailItem18() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.PINK));
    }

    /// @dev Hair N°19 => Classic 2 Red
    function hairDetailItem19() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.RED));
    }

    /// @dev Hair N°20 => Classic 2 Purple
    function hairDetailItem20() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.PURPLE));
    }

    /// @dev Hair N°21 => Classic 2 Green
    function hairDetailItem21() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.GREEN));
    }

    /// @dev Hair N°22 => Classic 2 Saiki
    function hairDetailItem22() public pure returns (string memory) {
        return hairBase(classicTwoHairs(Colors.SAIKI));
    }

    /// @dev Hair N°23 => Short Black
    function hairDetailItem23() public pure returns (string memory) {
        return hairBase(shortHairs(Colors.BLACK));
    }

    /// @dev Hair N°24 => Short Blue
    function hairDetailItem24() public pure returns (string memory) {
        return hairBase(shortHairs(Colors.BLUE));
    }

    /// @dev Hair N°25 => Short Pink
    function hairDetailItem25() public pure returns (string memory) {
        return hairBase(shortHairs(Colors.PINK));
    }

    /// @dev Hair N°26 => Short White
    function hairDetailItem26() public pure returns (string memory) {
        return hairBase(shortHairs(Colors.WHITE));
    }

    /// @dev Hair N°27 => Spike Black
    function hairDetailItem27() public pure returns (string memory) {
        return hairBase(spike(Colors.BLACK));
    }

    /// @dev Hair N°28 => Spike Blue
    function hairDetailItem28() public pure returns (string memory) {
        return hairBase(spike(Colors.BLUE));
    }

    /// @dev Hair N°29 => Spike Pink
    function hairDetailItem29() public pure returns (string memory) {
        return hairBase(spike(Colors.PINK));
    }

    /// @dev Hair N°30 => Spike White
    function hairDetailItem30() public pure returns (string memory) {
        return hairBase(spike(Colors.WHITE));
    }

    /// @dev Hair N°31 => Monk
    function hairDetailItem31() public pure returns (string memory) {
        return hairBase(monk());
    }

    /// @dev Hair N°32 => Nihon
    function hairDetailItem32() public pure returns (string memory) {
        return
            hairBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Hair N°33 => Bald
    function hairDetailItem33() public pure returns (string memory) {
        return
            hairBase(
                string(
                    abi.encodePacked(
    ...
    function getHairItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Classic Brown";
        } else if (id == 2) {
    ...
    /// @dev The hairBase SVG for the hair
    function hairBase(string memory children) private pure returns (string memory) {
