...
contract EarringsDetail {
    /// @dev Earrings N°1 => Classic
    function earringsDetailItem1() public pure returns (string memory) {
        return "";
    }

    /// @dev Earrings N°2 => Circle
    function earringsDetailItem2() public pure returns (string memory) {
        return earringsBase(circle("000000"));
    }

    /// @dev Earrings N°3 => Circle Silver
    function earringsDetailItem3() public pure returns (string memory) {
        return earringsBase(circle("C7D2D4"));
    }

    /// @dev Earrings N°4 => Ring
    function earringsDetailItem4() public pure returns (string memory) {
        return earringsBase(ring("000000"));
    }

    /// @dev Earrings N°5 => Circle Gold
    function earringsDetailItem5() public pure returns (string memory) {
        return earringsBase(circle("FFDD00"));
    }

    /// @dev Earrings N°6 => Ring Gold
    function earringsDetailItem6() public pure returns (string memory) {
        return earringsBase(ring("FFDD00"));
    }

    /// @dev Earrings N°7 => Heart
    function earringsDetailItem7() public pure returns (string memory) {
        return
            earringsBase(
                string(
                    abi.encodePacked(
    ...
    function earringsDetailItem8() public pure returns (string memory) {
        return
            earringsBase(
                string(
                    abi.encodePacked(
    ...
    function earringsDetailItem9() public pure returns (string memory) {
        return earringsBase(circle("AAFFFD"));
    }

    /// @dev Earrings N°10 => Drop Heart
    function earringsDetailItem10() public pure returns (string memory) {
        return
            earringsBase(
                string(
                    abi.encodePacked(
    ...
    function earringsDetailItem11() public pure returns (string memory) {
        return
            earringsBase(
                string(
                    abi.encodePacked(
    ...
    function earringsDetailItem12() public pure returns (string memory) {
        return
            earringsBase(
                string(
                    abi.encodePacked(
    ...
    function getEarringsItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Classic";
        } else if (id == 2) {
    ...
    /// @dev The earringsBase SVG for the earrings
    function earringsBase(string memory children) private pure returns (string memory) {
