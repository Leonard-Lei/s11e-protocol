...
contract NoseDetail {
    ...
    function noseDetailItem1() public pure returns (string memory) {
        return "";
    }

    /// @dev Nose N°2 => Bleeding
    function noseDetailItem2() public pure returns (string memory) {
        return
            noseBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev The noseBase SVG for the Nose
    function noseBase(
