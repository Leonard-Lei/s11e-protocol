...
contract MarkDetail {
    ...
    function markDetailItem1() public pure returns (string memory) {
        return "";
    }

    /// @dev Mark N°2 => Blush Cheeks
    function markDetailItem2() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    function markDetailItem3() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    function markDetailItem4() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°5 => Blush
    function markDetailItem5() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°6 => Chin
    function markDetailItem6() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    function markDetailItem7() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°8 => Scar
    function markDetailItem8() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°9 => Sun
    function markDetailItem9() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°10 => Moon
    function markDetailItem10() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    function markDetailItem11() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°12 => Tori
    function markDetailItem12() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev Mark N°13 => Ether
    function markDetailItem13() public pure returns (string memory) {
        return
            markBase(
                string(
                    abi.encodePacked(
    ...
    function getMarkItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Classic";
        } else if (id == 2) {
    ...
    /// @dev The markBase SVG for the hair
    function markBase(string memory children) private pure returns (string memory) {
