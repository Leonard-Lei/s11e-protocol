...
contract AccessoryDetail {
    /// @dev Accessory N°1 => Classic
    function accessoryDetailItem1() public pure returns (string memory) {
        return "";
    }

    /// @dev Accessory N°2 => Glasses
    function accessoryDetailItem2() public pure returns (string memory) {
        return accessoryBase(glasses("D1F5FF", "000000", "0.31"));
    }

    /// @dev Accessory N°3 => Bow Tie
    function accessoryDetailItem3() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem4() public pure returns (string memory) {
        return accessoryBase(monkBeads("63205A"));
    }

    /// @dev Accessory N°5 => Monk Beads Silver
    function accessoryDetailItem5() public pure returns (string memory) {
        return accessoryBase(monkBeads("C7D2D4"));
    }

    /// @dev Accessory N°6 => Power Pole
    function accessoryDetailItem6() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem7() public pure returns (string memory) {
        return accessoryBase(glasses("FC55FF", "DFA500", "0.31"));
    }

    /// @dev Accessory N°8 => Monk Beads Gold
    function accessoryDetailItem8() public pure returns (string memory) {
        return accessoryBase(monkBeads("FFDD00"));
    }

    /// @dev Accessory N°9 => Eye Patch
    function accessoryDetailItem9() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem10() public pure returns (string memory) {
        return accessoryBase(glasses(Colors.BLACK, Colors.BLACK_DEEP, "1"));
    }

    /// @dev Accessory N°11 => Monk Beads Diamond
    function accessoryDetailItem11() public pure returns (string memory) {
        return accessoryBase(monkBeads("AAFFFD"));
    }

    /// @dev Accessory N°12 => Horns
    function accessoryDetailItem12() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem13() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem14() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function accessoryDetailItem15() public pure returns (string memory) {
        return
            accessoryBase(
                string(
                    abi.encodePacked(
    ...
    function getAccessoryItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Classic";
        } else if (id == 2) {
    ...
    /// @dev The accessoryBase SVG for the accessory
    function accessoryBase(string memory children) private pure returns (string memory) {
