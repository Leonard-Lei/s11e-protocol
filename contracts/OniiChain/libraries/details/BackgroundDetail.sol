...
contract BackgroundDetail {
    /// @dev background N°1 => Ordinary
    function backgroundDetailItem1() public pure returns (string memory) {
        return backgroundBase("636363", "CFCFCF", "ABABAB");
    }

    /// @dev background N°2 => Unusual
    function backgroundDetailItem2() public pure returns (string memory) {
        return backgroundBase("004A06", "61E89B", "12B55F");
    }

    /// @dev background N°3 => Surprising
    function backgroundDetailItem3() public pure returns (string memory) {
        return backgroundBase("1A4685", "6BF0E3", "00ADC7");
    }

    /// @dev background N°4 => Impressive
    function backgroundDetailItem4() public pure returns (string memory) {
        return backgroundBase("380113", "D87AE6", "8A07BA");
    }

    /// @dev background N°5 => Extraordinary
    function backgroundDetailItem5() public pure returns (string memory) {
        return backgroundBase("A33900", "FAF299", "FF9121");
    }

    /// @dev background N°6 => Phenomenal
    function backgroundDetailItem6() public pure returns (string memory) {
        return backgroundBase("000000", "C000E8", "DED52C");
    }

    /// @dev background N°7 => Artistic
    function backgroundDetailItem7() public pure returns (string memory) {
        return backgroundBase("FF00E3", "E8E18B", "00C4AD");
    }

    /// @dev background N°8 => Unreal
    function backgroundDetailItem8() public pure returns (string memory) {
        return backgroundBase("CCCC75", "54054D", "001E2E");
    }

    /// @notice Return the background name of the given id
    /// @param id The background Id
    function getBackgoundItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Ordinary";
        } else if (id == 2) {
    ...
    /// @dev The backgroundBase SVG for the backgrounds
