...
contract EyebrowDetail {
    /// @dev Eyebrow N°1 => Classic
    function eyebrowDetailItem1() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function eyebrowDetailItem2() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function eyebrowDetailItem3() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function eyebrowDetailItem4() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function eyebrowDetailItem5() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function eyebrowDetailItem6() public pure returns (string memory) {
        return
            eyebrowBase(
                string(
                    abi.encodePacked(
    ...
    function getEyeItemNameById(uint8 id) public pure returns (string memory name) {
        name = "";
        if (id == 1) {
            name = "Classic";
        } else if (id == 2) {
    ...
    /// @dev The eyebrowBase SVG for the Eyebrow
    function eyebrowBase(string memory children) private pure returns (string memory) {
