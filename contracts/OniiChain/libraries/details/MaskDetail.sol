...
contract MaskDetail {
    ...
    function maskDetailItem1() public pure returns (string memory) {
        return "";
    }

    /// @dev Mask N°2 => Classic
    function maskDetailItem2() public pure returns (string memory) {
        return maskBase(classicMask("575673"));
    }

    /// @dev Mask N°3 => Blue
    function maskDetailItem3() public pure returns (string memory) {
        return maskBase(classicMask(Colors.BLUE));
    }

    /// @dev Mask N°4 => Pink
    function maskDetailItem4() public pure returns (string memory) {
        return maskBase(classicMask(Colors.PINK));
    }

    /// @dev Mask N°5 => Black
    function maskDetailItem5() public pure returns (string memory) {
        return maskBase(classicMask(Colors.BLACK));
    }

    /// @dev Mask N°6 => Bandage White
    function maskDetailItem6() public pure returns (string memory) {
        return
            maskBase(
                string(abi.encodePacked(classicMask("F5F5F5"), bandage()))
            );
    }

    /// @dev Mask N°7 => Bandage Classic
    function maskDetailItem7() public pure returns (string memory) {
        return
            maskBase(
                string(abi.encodePacked(classicMask("575673"), bandage()))
            );
    }

    /// @dev Mask N°8 => Nihon
    function maskDetailItem8() public pure returns (string memory) {
        return
            maskBase(
                string(
                    abi.encodePacked(
    ...
    /// @dev The maskBase SVG for the eyes
    function maskBase(
