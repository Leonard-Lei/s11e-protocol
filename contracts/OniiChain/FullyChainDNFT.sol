...
// /// @title FullyChainDNFT NFTs
// /// @notice On-chain generated NFTs
// contract FullyChainDNFT is
//     ERC721Enumerable,
//     Ownable,
//     IFullyChainDNFT,
//     ReentrancyGuard
...
//     // )
//     constructor(address _tokenDescriptor_) ERC721("FullyChainDNFT", "ONII") {
...
//         // );
//         return
//             IFullyChainDNFTDescriptor(_tokenDescriptor).tokenURI(this, tokenId);
//     }
...
//                 hair: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateHairId(nextTokenId, seed),
//                 eye: IFullyChainDNFTDescriptor(_tokenDescriptor).generateEyeId(
//                     nextTokenId,
//                     seed
//                 ),
//                 eyebrow: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateEyebrowId(nextTokenId, seed),
//                 nose: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateNoseId(nextTokenId, seed),
//                 mouth: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateMouthId(nextTokenId, seed),
//                 mark: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateMarkId(nextTokenId, seed),
//                 earrings: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateEarringsId(nextTokenId, seed),
//                 accessory: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateAccessoryId(nextTokenId, seed),
//                 mask: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateMaskId(nextTokenId, seed),
//                 skin: IFullyChainDNFTDescriptor(_tokenDescriptor)
//                     .generateSkinId(nextTokenId, seed),
//                 original: true,
...
//         require(
//             payable(0x838D23a8A17adaa6866969b86D35Ac0941C67510).send(
//                 (amount * 45) / 100
//             )
//         );
//         require(
//             payable(0x29B862E8c25e7f0fa5b2A89b65b186d18D45f54e).send(
//                 (amount * 55) / 100
//             )
//         );
//     }

//     /// @inheritdoc IFullyChainDNFT
//     function details(
//         uint256 tokenId
//     ) external view override returns (Detail memory detail) {
